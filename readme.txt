...
У генератора имеется 2 выхода — A (красный), D (белый) и вход — E (зеленый). Сигналы в режимах синус, треугольник, пила, обратная пила, ЭКГ, шум, ТВ, PUSLSE, DTMF, SWEEP выводятся на выход A.
